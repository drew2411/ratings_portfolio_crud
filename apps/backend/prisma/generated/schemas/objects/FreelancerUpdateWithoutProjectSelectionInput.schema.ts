...
const Schema: z.ZodType<Prisma.FreelancerUpdateWithoutProjectSelectionInput> = z
  .object({
    freelancerID: z
      .union([
        z.string(),
...
export const FreelancerUpdateWithoutProjectSelectionInputObjectSchema = Schema;
