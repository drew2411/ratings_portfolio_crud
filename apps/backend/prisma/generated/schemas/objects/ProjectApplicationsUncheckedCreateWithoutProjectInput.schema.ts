...
const Schema: z.ZodType<Prisma.ProjectApplicationsUncheckedCreateWithoutProjectInput> =
  z
    .object({
...
export const ProjectApplicationsUncheckedCreateWithoutProjectInputObjectSchema =
  Schema;
