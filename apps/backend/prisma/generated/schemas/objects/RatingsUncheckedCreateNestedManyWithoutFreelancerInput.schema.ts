...
const Schema: z.ZodType<Prisma.RatingsUncheckedCreateNestedManyWithoutFreelancerInput> =
  z
    .object({
      create: z
        .union([
...
export const RatingsUncheckedCreateNestedManyWithoutFreelancerInputObjectSchema =
  Schema;
