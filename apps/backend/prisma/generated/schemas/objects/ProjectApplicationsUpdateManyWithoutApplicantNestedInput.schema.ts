...
const Schema: z.ZodType<Prisma.ProjectApplicationsUpdateManyWithoutApplicantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectApplicationsUpdateManyWithoutApplicantNestedInputObjectSchema =
  Schema;
