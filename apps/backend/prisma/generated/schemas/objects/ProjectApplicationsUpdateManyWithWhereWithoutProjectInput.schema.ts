...
const Schema: z.ZodType<Prisma.ProjectApplicationsUpdateManyWithWhereWithoutProjectInput> =
  z
    .object({
...
export const ProjectApplicationsUpdateManyWithWhereWithoutProjectInputObjectSchema =
  Schema;
