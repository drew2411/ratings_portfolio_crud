...
const Schema: z.ZodType<Prisma.ProjectUncheckedUpdateWithoutProjectSelectionInput> =
  z
    .object({
      projectID: z
        .union([
...
export const ProjectUncheckedUpdateWithoutProjectSelectionInputObjectSchema =
  Schema;
