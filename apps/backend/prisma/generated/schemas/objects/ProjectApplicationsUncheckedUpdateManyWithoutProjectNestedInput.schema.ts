...
const Schema: z.ZodType<Prisma.ProjectApplicationsUncheckedUpdateManyWithoutProjectNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectApplicationsUncheckedUpdateManyWithoutProjectNestedInputObjectSchema =
  Schema;
