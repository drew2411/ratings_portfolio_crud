...
const Schema: z.ZodType<Prisma.RatingsUncheckedUpdateManyWithoutClientNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => RatingsUpdateManyWithWhereWithoutClientInputObjectSchema
          ),
          z
            .lazy(
              () => RatingsUpdateManyWithWhereWithoutClientInputObjectSchema
...
export const RatingsUncheckedUpdateManyWithoutClientNestedInputObjectSchema =
  Schema;
