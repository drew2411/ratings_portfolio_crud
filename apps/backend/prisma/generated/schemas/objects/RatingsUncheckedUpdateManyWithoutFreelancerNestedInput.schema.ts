...
const Schema: z.ZodType<Prisma.RatingsUncheckedUpdateManyWithoutFreelancerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RatingsUncheckedUpdateManyWithoutFreelancerNestedInputObjectSchema =
  Schema;
