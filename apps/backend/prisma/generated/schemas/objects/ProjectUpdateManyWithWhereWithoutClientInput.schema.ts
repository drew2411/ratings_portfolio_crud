...
const Schema: z.ZodType<Prisma.ProjectUpdateManyWithWhereWithoutClientInput> = z
  .object({
...
export const ProjectUpdateManyWithWhereWithoutClientInputObjectSchema = Schema;
