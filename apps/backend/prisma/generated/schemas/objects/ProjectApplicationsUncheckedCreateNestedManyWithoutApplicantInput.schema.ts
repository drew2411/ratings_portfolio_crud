...
const Schema: z.ZodType<Prisma.ProjectApplicationsUncheckedCreateNestedManyWithoutApplicantInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectApplicationsUncheckedCreateNestedManyWithoutApplicantInputObjectSchema =
  Schema;
