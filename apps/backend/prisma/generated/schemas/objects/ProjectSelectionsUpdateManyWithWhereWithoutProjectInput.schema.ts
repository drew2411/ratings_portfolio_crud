...
const Schema: z.ZodType<Prisma.ProjectSelectionsUpdateManyWithWhereWithoutProjectInput> =
  z
    .object({
...
export const ProjectSelectionsUpdateManyWithWhereWithoutProjectInputObjectSchema =
  Schema;
