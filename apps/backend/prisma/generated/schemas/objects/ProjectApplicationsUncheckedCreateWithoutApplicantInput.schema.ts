...
const Schema: z.ZodType<Prisma.ProjectApplicationsUncheckedCreateWithoutApplicantInput> =
  z
    .object({
...
export const ProjectApplicationsUncheckedCreateWithoutApplicantInputObjectSchema =
  Schema;
