...
const Schema: z.ZodType<Prisma.ProjectSelectionsUncheckedCreateWithoutProjectInput> =
  z
    .object({
...
export const ProjectSelectionsUncheckedCreateWithoutProjectInputObjectSchema =
  Schema;
