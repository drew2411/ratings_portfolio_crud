...
const Schema: z.ZodType<Prisma.ProjectSelectionsUpdateWithoutSelectedFreelancerInput> =
  z
    .object({
...
export const ProjectSelectionsUpdateWithoutSelectedFreelancerInputObjectSchema =
  Schema;
