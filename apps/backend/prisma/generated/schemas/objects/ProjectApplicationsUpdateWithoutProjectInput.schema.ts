...
const Schema: z.ZodType<Prisma.ProjectApplicationsUpdateWithoutProjectInput> = z
  .object({
...
export const ProjectApplicationsUpdateWithoutProjectInputObjectSchema = Schema;
