...
const Schema: z.ZodType<Prisma.ProjectSelectionsUncheckedUpdateManyWithoutProjectNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectSelectionsUncheckedUpdateManyWithoutProjectNestedInputObjectSchema =
  Schema;
