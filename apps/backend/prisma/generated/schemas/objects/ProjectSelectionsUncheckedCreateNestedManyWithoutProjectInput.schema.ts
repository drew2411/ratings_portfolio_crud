...
const Schema: z.ZodType<Prisma.ProjectSelectionsUncheckedCreateNestedManyWithoutProjectInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectSelectionsUncheckedCreateNestedManyWithoutProjectInputObjectSchema =
  Schema;
