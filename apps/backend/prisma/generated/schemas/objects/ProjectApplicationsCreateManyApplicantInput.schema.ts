...
const Schema: z.ZodType<Prisma.ProjectApplicationsCreateManyApplicantInput> = z
  .object({
...
export const ProjectApplicationsCreateManyApplicantInputObjectSchema = Schema;
