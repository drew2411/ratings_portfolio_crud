...
const Schema: z.ZodType<Prisma.ProjectSelectionsCreateNestedManyWithoutSelectedFreelancerInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectSelectionsCreateNestedManyWithoutSelectedFreelancerInputObjectSchema =
  Schema;
