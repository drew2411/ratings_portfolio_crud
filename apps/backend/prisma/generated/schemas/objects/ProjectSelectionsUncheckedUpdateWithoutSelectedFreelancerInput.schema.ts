...
const Schema: z.ZodType<Prisma.ProjectSelectionsUncheckedUpdateWithoutSelectedFreelancerInput> =
  z
    .object({
...
export const ProjectSelectionsUncheckedUpdateWithoutSelectedFreelancerInputObjectSchema =
  Schema;
