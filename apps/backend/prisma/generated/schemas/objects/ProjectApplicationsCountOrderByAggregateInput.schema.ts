...
const Schema: z.ZodType<Prisma.ProjectApplicationsCountOrderByAggregateInput> =
  z
    .object({
...
export const ProjectApplicationsCountOrderByAggregateInputObjectSchema = Schema;
