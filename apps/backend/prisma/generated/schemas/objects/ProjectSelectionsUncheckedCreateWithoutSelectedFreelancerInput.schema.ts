...
const Schema: z.ZodType<Prisma.ProjectSelectionsUncheckedCreateWithoutSelectedFreelancerInput> =
  z
    .object({
...
export const ProjectSelectionsUncheckedCreateWithoutSelectedFreelancerInputObjectSchema =
  Schema;
