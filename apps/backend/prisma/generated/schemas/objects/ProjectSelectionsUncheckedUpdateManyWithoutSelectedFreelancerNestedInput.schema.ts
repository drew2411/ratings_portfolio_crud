...
const Schema: z.ZodType<Prisma.ProjectSelectionsUncheckedUpdateManyWithoutSelectedFreelancerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectSelectionsUncheckedUpdateManyWithoutSelectedFreelancerNestedInputObjectSchema =
  Schema;
