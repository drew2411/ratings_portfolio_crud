...
const Schema: z.ZodType<Prisma.ProjectApplicationsUncheckedUpdateManyInput> = z
  .object({
...
export const ProjectApplicationsUncheckedUpdateManyInputObjectSchema = Schema;
