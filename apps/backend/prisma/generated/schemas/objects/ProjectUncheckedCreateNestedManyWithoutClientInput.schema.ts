...
const Schema: z.ZodType<Prisma.ProjectUncheckedCreateNestedManyWithoutClientInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectUncheckedCreateNestedManyWithoutClientInputObjectSchema =
  Schema;
