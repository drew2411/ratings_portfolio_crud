...
const Schema: z.ZodType<Prisma.ProjectUpdateManyWithoutClientNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ProjectUpdateManyWithWhereWithoutClientInputObjectSchema),
        z
          .lazy(() => ProjectUpdateManyWithWhereWithoutClientInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ProjectUpdateManyWithoutClientNestedInputObjectSchema = Schema;
