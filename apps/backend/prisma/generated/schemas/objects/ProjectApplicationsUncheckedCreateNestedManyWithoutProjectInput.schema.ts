...
const Schema: z.ZodType<Prisma.ProjectApplicationsUncheckedCreateNestedManyWithoutProjectInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectApplicationsUncheckedCreateNestedManyWithoutProjectInputObjectSchema =
  Schema;
