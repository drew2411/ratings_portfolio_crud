...
const Schema: z.ZodType<Prisma.ProjectApplicationsMaxOrderByAggregateInput> = z
  .object({
...
export const ProjectApplicationsMaxOrderByAggregateInputObjectSchema = Schema;
