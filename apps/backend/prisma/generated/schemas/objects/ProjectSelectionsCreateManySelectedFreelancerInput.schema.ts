...
const Schema: z.ZodType<Prisma.ProjectSelectionsCreateManySelectedFreelancerInput> =
  z
    .object({
...
export const ProjectSelectionsCreateManySelectedFreelancerInputObjectSchema =
  Schema;
