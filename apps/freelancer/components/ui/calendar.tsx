...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-1  bg-[#4E5058] ", className)} //changing the properties of the overall table
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-5 w-7 bg-transparent p-0 opacity-50 hover:opacity-100"
        ),// just changing the month changing months
